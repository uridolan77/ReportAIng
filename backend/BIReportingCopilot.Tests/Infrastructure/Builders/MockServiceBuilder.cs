...
public class MockServiceBuilder
{
    ...
    /// </summary>
    public MockServiceBuilder WithMockSemanticCacheService(Action<Mock<BIReportingCopilot.Core.Interfaces.ISemanticCacheService>>? configure = null)
    {
        var mock = For<BIReportingCopilot.Core.Interfaces.ISemanticCacheService>();
