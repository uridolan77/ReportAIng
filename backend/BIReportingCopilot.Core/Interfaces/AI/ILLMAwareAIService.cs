...
{
    Task<BIReportingCopilot.Core.Models.Business.BusinessContext> GenerateContextAsync(string domain, CancellationToken cancellationToken = default);

    // Additional methods expected by Infrastructure services
    Task<BIReportingCopilot.Core.Models.Business.BusinessContext> GenerateContextFromSchemaAsync(SchemaMetadata schema, CancellationToken cancellationToken = default);
    Task<List<BIReportingCopilot.Core.Models.Business.BusinessContext>> GetAvailableContextsAsync(CancellationToken cancellationToken = default);
    Task<BIReportingCopilot.Core.Models.Business.BusinessContext> GenerateTableContextAsync(string tableName, SchemaMetadata schema, CancellationToken cancellationToken = default);
    Task<List<BIReportingCopilot.Core.Models.Business.BusinessContext>> GenerateTableContextsAsync(List<string> tableNames, SchemaMetadata schema, CancellationToken cancellationToken = default);
    Task<List<BIReportingCopilot.Core.Models.Business.BusinessTerm>> GenerateGlossaryTermsAsync(SchemaMetadata schema, CancellationToken cancellationToken = default);
    Task<List<BIReportingCopilot.Core.Models.Business.BusinessRelationship>> AnalyzeTableRelationshipsAsync(SchemaMetadata schema, CancellationToken cancellationToken = default);
