...
public interface ITuningService
{
    ...
    Task<PromptTemplateDto?> GetPromptTemplateAsync(long id);
    Task<PromptTemplateDto> CreatePromptTemplateAsync(CreatePromptTemplateRequest request, string userId);
    Task<PromptTemplateDto?> UpdatePromptTemplateAsync(long id, CreatePromptTemplateRequest request, string userId);
    Task<bool> DeletePromptTemplateAsync(long id);
    Task<bool> ActivatePromptTemplateAsync(long id, string userId);
    Task<bool> DeactivatePromptTemplateAsync(long id, string userId);
    Task<PromptTemplateTestResult> TestPromptTemplateAsync(long id, PromptTemplateTestRequest request);
