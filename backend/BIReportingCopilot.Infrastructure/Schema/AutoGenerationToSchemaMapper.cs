...
public static class AutoGenerationToSchemaMapper
{
        ...
        Guid? existingSchemaId = null)
    {
        ...
        {
            SchemaId = existingSchemaId ?? Guid.Empty,
            ...
            SetAsCurrent = true,
            ChangeLog = new List<BIReportingCopilot.Core.DTOs.SchemaChangeLogEntry>
            {
                new BIReportingCopilot.Core.DTOs.SchemaChangeLogEntry
                {
