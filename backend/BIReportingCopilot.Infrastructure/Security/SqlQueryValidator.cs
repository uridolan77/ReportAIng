...
/// <summary>
/// SQL query validator with ML-based anomaly detection and comprehensive security checks
...
/// <summary>
/// SQL pattern for validation
/// </summary>
public record SqlPattern(string Name, string Pattern, int RiskScore);
