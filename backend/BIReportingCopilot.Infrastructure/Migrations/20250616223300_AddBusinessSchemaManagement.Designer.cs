...
namespace BIReportingCopilot.Infrastructure.Migrations
{
    ...
    [Migration("20250616223300_AddBusinessSchemaManagement")]
    partial class AddBusinessSchemaManagement
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.AIGenerationAttempt", b =>
                {
                    ...
                    b.Property<long?>("GenerationAttemptId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.UnifiedAIGenerationAttempt", b =>
                {
                    ...
                    b.ToTable("UnifiedAIGenerationAttempt");
                });
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.PromptTemplateEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9565),
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.SystemConfigurationEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9375),
                            DataType = "int",
                            Description = "Maximum time allowed for query execution",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9379),
                            UpdatedBy = "System",
                            Value = "30"
                        },
                        new
                        {
                            Key = "MaxResultRows",
                            CreatedDate = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9380),
                            DataType = "int",
                            Description = "Maximum number of rows returned per query",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9381),
                            UpdatedBy = "System",
                            Value = "10000"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9382),
                            DataType = "bool",
                            Description = "Enable caching of query results",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9383),
                            UpdatedBy = "System",
                            Value = "true"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9384),
                            DataType = "int",
                            Description = "Default cache expiry time in hours",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9385),
                            UpdatedBy = "System",
                            Value = "24"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9385),
                            DataType = "bool",
                            Description = "Enable comprehensive audit logging",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9386),
                            UpdatedBy = "System",
                            Value = "true"
                        });
                });
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-user-001",
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2025, 6, 16, 22, 32, 59, 999, DateTimeKind.Utc).AddTicks(9594),
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.AIGenerationAttempt", b =>
                {
                    ...
                    b.HasOne("BIReportingCopilot.Core.Models.UnifiedQueryHistoryEntity", "QueryHistory")
                        .WithMany()
