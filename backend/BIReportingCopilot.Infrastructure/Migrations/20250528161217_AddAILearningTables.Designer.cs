...
namespace BIReportingCopilot.Infrastructure.Migrations
{
    ...
    [Migration("20250528161217_AddAILearningTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.AIFeedbackEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.AIGenerationAttempt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.QueryHistoryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.SemanticCacheEntry", b =>
                {
                    ...
                    b.Property<string>("DatabaseContext")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double>("SemanticSimilarityThreshold")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.PromptTemplateEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9645),
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.SystemConfigurationEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9536),
                            DataType = "int",
                            Description = "Maximum time allowed for query execution",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9538),
                            UpdatedBy = "System",
                            Value = "30"
                        },
                        new
                        {
                            Key = "MaxResultRows",
                            CreatedDate = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9539),
                            DataType = "int",
                            Description = "Maximum number of rows returned per query",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9540),
                            UpdatedBy = "System",
                            Value = "10000"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9541),
                            DataType = "bool",
                            Description = "Enable caching of query results",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9541),
                            UpdatedBy = "System",
                            Value = "true"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9542),
                            DataType = "int",
                            Description = "Default cache expiry time in hours",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9543),
                            UpdatedBy = "System",
                            Value = "24"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9543),
                            DataType = "bool",
                            Description = "Enable comprehensive audit logging",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9544),
                            UpdatedBy = "System",
                            Value = "true"
                        });
                });
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "admin-user-001",
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2025, 5, 28, 16, 12, 17, 313, DateTimeKind.Utc).AddTicks(9664),
            ...
            modelBuilder.Entity("BIReportingCopilot.Core.Models.AIFeedbackEntry", b =>
                {
                    b.HasOne("BIReportingCopilot.Core.Models.AIGenerationAttempt", "GenerationAttempt")
                        .WithMany()
                        .HasForeignKey("GenerationAttemptId");

                    b.HasOne("BIReportingCopilot.Core.Models.QueryHistoryEntity", "QueryHistory")
                        .WithMany()
