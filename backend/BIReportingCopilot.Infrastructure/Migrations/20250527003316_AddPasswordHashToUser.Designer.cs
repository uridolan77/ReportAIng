...
namespace BIReportingCopilot.Infrastructure.Migrations
{
    ...
    [Migration("20250527003316_AddPasswordHashToUser")]
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.PromptTemplateEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "System",
                            CreatedDate = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3135),
            ...
            modelBuilder.Entity("BIReportingCopilot.Infrastructure.Data.Entities.SystemConfigurationEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3015),
                            DataType = "int",
                            Description = "Maximum time allowed for query execution",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3017),
                            UpdatedBy = "System",
                            Value = "30"
                        },
                        new
                        {
                            Key = "MaxResultRows",
                            CreatedDate = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3018),
                            DataType = "int",
                            Description = "Maximum number of rows returned per query",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3019),
                            UpdatedBy = "System",
                            Value = "10000"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3019),
                            DataType = "bool",
                            Description = "Enable caching of query results",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3020),
                            UpdatedBy = "System",
                            Value = "true"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3021),
                            DataType = "int",
                            Description = "Default cache expiry time in hours",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3022),
                            UpdatedBy = "System",
                            Value = "24"
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3022),
                            DataType = "bool",
                            Description = "Enable comprehensive audit logging",
                            IsEncrypted = false,
                            LastUpdated = new DateTime(2025, 5, 27, 0, 33, 16, 65, DateTimeKind.Utc).AddTicks(3023),
                            UpdatedBy = "System",
                            Value = "true"
                        });
                });
