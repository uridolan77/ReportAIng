        ...
        try
        {
            ...
            var autoGenResponse = new AutoGenerationResponse
            {
                ...
                GeneratedTableContexts = response.GeneratedTables?.Select(bt => new AutoGeneratedTableContext
                {
                    ...
                    KeyBusinessMetrics = new List<string>(), // BusinessTable doesn't have this property
                    CommonQueryPatterns = new List<string>(), // BusinessTable doesn't have this property
                    BusinessRules = "", // BusinessTable doesn't have this property
