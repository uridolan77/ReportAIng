...
namespace BIReportingCopilot.API.Scripts;

/// <summary>
/// Script to update the sql_generation prompt template with improved aggregation rules
/// </summary>
...
ORDER BY column1 DESC";
            ...
            template.Description = "Enhanced SQL generation template with improved aggregation rules and player data structure";
