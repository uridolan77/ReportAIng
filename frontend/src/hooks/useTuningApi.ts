...
export const useUpdateBusinessTable = () => {
  ...
  return useMutation({
    mutationFn: (table: any) => tuningApiService.updateBusinessTable(table),
...
export const useUpdateQueryPattern = () => {
  ...
  return useMutation({
    mutationFn: (pattern: any) => tuningApiService.updateQueryPattern(pattern),
...
export const useAutoGenerateTableDescriptions = () => {
  ...
  return useMutation({
    mutationFn: () => tuningApiService.autoGenerateTableDescriptions(),
...
export const useAutoGenerateGlossary = () => {
  ...
  return useMutation({
    mutationFn: () => tuningApiService.autoGenerateGlossary(),
