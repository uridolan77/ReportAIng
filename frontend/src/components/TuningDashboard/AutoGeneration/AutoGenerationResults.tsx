...
import { Card, Button, Space, Typography, Tabs, Table, Tag, Alert, Statistic, Row, Col, Collapse, Badge, Tooltip } from 'antd';
import { CheckCircleOutlined, ExclamationCircleOutlined, TableOutlined, BookOutlined, ShareAltOutlined, EyeOutlined, DeleteOutlined, SaveOutlined } from '@ant-design/icons';
    ...
    },
    {
      ...
      render: (record: AutoGeneratedTableContext) => (
        <Button
          type="link"
          icon={<EyeOutlined />}
          onClick={() => setSelectedTableContext(record)}
        >
          View Details
        </Button>
      ),
    ...
    },
    {
      ...
      render: (record: AutoGeneratedGlossaryTerm) => (
        <Button
          type="link"
          icon={<EyeOutlined />}
          onClick={() => setSelectedGlossaryTerm(record)}
        >
          View Details
        </Button>
      ),
