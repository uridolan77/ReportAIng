...
import { Card, Button, Space, Typography, Alert, Spin, Progress, Divider, Row, Col, Switch, InputNumber, Select, message } from 'antd';
import { RobotOutlined, TableOutlined, BookOutlined, ShareAltOutlined, PlayCircleOutlined, CheckCircleOutlined, ExclamationCircleOutlined } from '@ant-design/icons';
import { tuningApi, AutoGenerationRequest, AutoGenerationResponse, AutoGeneratedTableContext, AutoGeneratedGlossaryTerm } from '../../../services/tuningApi';
